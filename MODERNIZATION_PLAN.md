...
| **8. Testing** | Vitest (server services + authz), Supertest (API), socket integration tests, Playwright (auth, messaging between two users, mobile viewport), manual checklist | CI green | Next |
